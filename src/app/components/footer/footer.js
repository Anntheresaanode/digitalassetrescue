						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16">
							<div className="space-y-3 lg:col-span-2">
								...
								<p className="text-gray-400">
									The Recovera is a leading asset recovery company dedicated to
									helping individuals and businesses reclaim their lost assets.
									With years of experience in the industry, our team of experts
									is committed to providing exceptional service and delivering
									results.
								</p>
								<form
									id="newsletter"
				...
				<PageLayout>
					<div className="flex flex-col-reverse lg:flex-row items-center lg:justify-between gap-5">
						<p className="text-center lg:text-left font-bold text-sm text-white">
							&copy; 2014 - {new Date().getFullYear()} The Recovera. All rights
							reserved.
						</p>
	...
	return (
		<div className="space-y-4">
			...
			<div className="flex items-center gap-3 pb-4 border-b border-white border-opacity-10">
				...
				<div>
					<a href="https://t.me/therecovera" className="text-white font-medium">
						+1 (480) 500 6302
					</a>
				</div>
			</div>
