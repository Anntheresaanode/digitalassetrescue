			...
			<PageLayout>
				<div className="py-10 relative flex flex-col-reverse lg:flex-row items-center justify-between">
					...
					<motion.div
						...
						// data-aos="fade-up"
						>
							<SubHeader>The Recovera overview</SubHeader>
						</div>
						<h2 className="text-left" data-aos="fade-up">
							Services We Provide
						</h2>
						<p data-aos="fade-up">
							The Recovera is a leading crypto recovery company that helps
							individuals and businesses reclaim lost or stolen assets from
							online scams, including forex, romance, investment scams, and
