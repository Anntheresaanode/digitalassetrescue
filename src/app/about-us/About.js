...
function About() {
	return (
		<div>
			{/* <Seo title="The Recovera - About Us" /> */}
				...
				<div className="w-full py-20 space-y-10 lg:space-y-20">
					<Sections reverse={false}>
						<div className="lg:w-1/2">
							<SubHeader>About The Recovera</SubHeader>
							<h2 data-aos="fade-up">About Us</h2>
							<p data-aos="fade-up">
								The Recovera is a leading asset and cryptocurrency recovery
					...
					<Sections reverse={true}>
						<div className="lg:w-1/2">
							<SubHeader>The Recovera Mission</SubHeader>
					...
					<Sections reverse={false}>
						<div className="lg:w-1/2">
							<SubHeader>The Recovera Services</SubHeader>
					...
					<Sections reverse={true}>
						<div className="lg:w-1/2">
							<SubHeader>The Recovera Team</SubHeader>
					...
					<Sections reverse={false}>
						<div className="lg:w-1/2">
							<SubHeader>The Recovera Success</SubHeader>
							<h2 data-aos="fade-up">Our Success Rate</h2>
							<p data-aos="fade-up">
								The Recovera has a proven track record of success. We have
								helped clients recover large amount of dollars in lost funds and
								stolen assets.
							</p>
						</div>
						<div className="lg:w-1/2">
